...
/**
 * Test case for class Tx_Mrkeperson_Controller_PersonController.
 *
 * @version $Id$
 ...
 */
class Tx_Mrkeperson_Controller_PersonControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
