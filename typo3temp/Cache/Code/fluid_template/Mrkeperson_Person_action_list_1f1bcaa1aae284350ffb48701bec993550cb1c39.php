<?php
class FluidCache_Mrkeperson_Person_action_list_1f1bcaa1aae284350ffb48701bec993550cb1c39 extends Tx_Fluid_Core_Compiler_AbstractCompiledTemplate {
...
$arguments4['value'] = Tx_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'certificates.uid', $renderingContext);
...
$arguments87['value'] = Tx_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'certificates.uid', $renderingContext);
