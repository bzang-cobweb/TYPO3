<?php
class FluidCache_Mrkeperson_Person_action_list_f88f0769e8da5216209c8d6fe2359c4039b144dd extends Tx_Fluid_Core_Compiler_AbstractCompiledTemplate {
...
$arguments4['value'] = Tx_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'certificates.id', $renderingContext);
...
$arguments87['value'] = Tx_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'certificates.id', $renderingContext);
